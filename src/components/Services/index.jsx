      ...
      <Fade bottom>
        <ServicesContainer>
          <Service
            ...
            text="A GMA realiza amostragens isocinéticas e avaliações de emissões gasosas atmosféricas provenientes de fontes estacionárias (dutos e chaminés) de processos produtivos em concordância com órgãos ambientais nacionais e internacionais."
            list={[
